...
?>
	...
	<div class="navigation">
	 ...
	 <span class="txt_nav" > &rsaquo; </span>
	 <span><a class="txt_cat" href="http://www.jophasworks.com/app/ezin/ezin/staff/sessou_francis.php">Sessou Francis</a></span>
			...
			<ul class="box_staff">
				...
				<li class="pos_staff">
				 <div class="photo float_left" style="clear:both;">
					<div class="patronime">
						<span>SESSOU FRANCIS</span>
					</div>
					<div class="identite">
						<a class="staff_poste" href="http://www.jophasworks.com/app/ezin/img/staff/francis/francis_z.jpg"><img class="pos_identite" src="http://www.jophasworks.com/app/ezin/img/staff/francis/francis.jpg" width="240" /><span><img src="http://www.jophasworks.com/app/ezin/img/plus.png" /></span></a>
					<!--
					</div>-->
	...
	<!-- Google CDN jQuery with fallback to local -->
					...
					<div class="lk_cv">
						<div class="pdf_img">
						  <a  class="img_lk" href="http://www.jophasworks.com/app/ezin/img/staff/francis/default.pdf"><img src="http://www.jophasworks.com/app/ezin/img/staff/pdf.png" width="18" />&nbsp;&nbsp;Téléchargez ! &nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i style="color:rgb(53,128,9); text-shadow:1px 1px 1px rgb(0,0,0);">SESSOU FRANCIS</i></a>
						</div>
				 ...
				 <div class="poste">
					<span>Directeur du département immobilier</span>
				 </div>
				 <div class="lk_video">
			...
			<div class="cv_pdf">
				<iframe src="http://www.jophasworks.com/app/ezin/img/staff/francis/default.pdf" width="866" height="800">
