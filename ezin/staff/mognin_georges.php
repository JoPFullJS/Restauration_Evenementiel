...
?>
	...
	<div class="navigation">
	 ...
	 <span class="txt_nav" > &rsaquo; </span>
	 <span><a class="txt_cat" href="http://www.jophasworks.com/app/ezin/ezin/staff/mognin_georges.php">Mognin Georges</a></span>
			...
			<ul class="box_staff">
				...
				<li class="pos_staff">
				 <div class="photo float_left" style="clear:both;">
					<div class="patronime">
						<span>MOGNIN GEORGES</span>
					</div>
					<div class="identite">
						<a class="staff_poste" href="http://www.jophasworks.com/app/ezin/img/staff/georges/georges_z.jpg"><img class="pos_identite" src="http://www.jophasworks.com/app/ezin/img/staff/georges/georges.jpg" width="240" /><span><img src="http://www.jophasworks.com/app/ezin/img/plus.png" /></span></a>
					<!--
					</div>-->
	...
	<!-- Google CDN jQuery with fallback to local -->
					...
					<div class="lk_cv">
						<div class="pdf_img">
						  <a  class="img_lk" href="http://www.jophasworks.com/app/ezin/img/staff/georges/default.pdf"><img src="http://www.jophasworks.com/app/ezin/img/staff/pdf.png" width="18" />&nbsp;&nbsp;Téléchargez ! &nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i style="color:rgb(53,128,9); text-shadow:1px 1px 1px rgb(0,0,0);">MOGNIN GEORGES</i></a>
						</div>
				 ...
				 <div class="poste">
					<span>Directeur du département de la communication chargé de l'audio-visuel</span>
				 </div>
				 <div class="lk_video">
			...
			<div class="cv_pdf">
				<iframe src="http://www.jophasworks.com/app/ezin/img/staff/georges/default.pdf" width="866" height="800">
